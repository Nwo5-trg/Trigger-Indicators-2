...
void drawIndicator(cocos2d::CCPoint triggerPos, cocos2d::CCPoint targetPos, cocos2d::ccColor4F col);
void drawIndicatorWithRect(cocos2d::CCPoint triggerPos, const std::vector<GameObject*>& objs, cocos2d::ccColor4F col);

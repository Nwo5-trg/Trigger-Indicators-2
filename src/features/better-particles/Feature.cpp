...
namespace BetterParticles {
    ...
    void drawRadial(const ParticleStruct& particleData, CCPoint pos, float scale) {
    ...
    void drawRadialSegment(const ParticleStruct& particleData, CCPoint pos, float scale, bool start) {
    ...
    void drawRect(const ParticleStruct& particleData, cocos2d::CCPoint pos, cocos2d::CCSize scale, float rotation) {

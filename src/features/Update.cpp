...
void Update::draw(LevelEditorLayer* editor) {
    if (!Settings::updateWhenPlaytesting && Cache::playtesting) return;
...
void Update::updateLayerAlpha(GameObject* obj) {
...
void Update::updateThicknessCache() {
